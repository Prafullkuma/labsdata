                    ...
                    <Typography className="userdata">
                        <form onSubmit={saveDataHanlder}>
                            ...
                            <div className="Data_use">
                                ...
                                <select value={Sname} required onChange={e => setSname(e.target.value)}>
                                    <option value="S.D.HighScholl" selected >S.D High school</option>
                            ...
                            <div className="Data_use">
                                ...
                                <select value={classs} required onChange={e => setClasss(e.target.value)}>
                            ...
                            <div className="Data_use">
                                ...
                                <select value={division} required onChange={e => setDivision(e.target.value)}>
                                    <option value="div A"  selected>Division A</option>
