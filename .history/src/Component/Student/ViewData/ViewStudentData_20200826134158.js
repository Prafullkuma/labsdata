...
function ViewStudentData({ id, search, allData }) {
    ...
    return (
        <div className="all_Data">
                            ...
                            <Typography className="userdata">
                                <form>
                                    ...
                                    <div className="Data_use">
                                        ...
                                        <select required value={Sname} onChange={e => setSname(e.target.value)}>
                                    ...
                                    <div className="Data_use">
                                        ...
                                        <select required value={classs} onChange={e => setClasss(e.target.value)}>
            ...
            <table border="1">
                <tr>
                    {search === "" && allData.schoolname.indexOf(search.toLowerCase() === -1) ? <h1>TAtti</h1> :
                        <div>
                            <td>{allData.name}</td>
                            <td>{allData.date}</td>
                            <td>{allData.schoolname}</td>
                            <td>{allData.class}</td>
